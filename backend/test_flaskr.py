...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_delete_questions(self):
        question = Question(question=self.test_questions['question'], answer=self.test_questions['answer'], category=self.test_questions['category'], difficulty=self.test_questions['difficulty'])
        question.insert()
